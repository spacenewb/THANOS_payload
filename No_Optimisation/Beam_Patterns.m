...
function [max_teta_steering,max_psi_steering,N_z,N_x] = Beam_Patterns(P_tx,P_tx_peak,As,Orb_alt,Orb_V,theta_pointing,theta_0,teta_i,psi_i,array_spacing,f0,La_z,La_x)
...
saveas(fig1, 'Graphs\2D\ArrayElements.fig')
close(fig1)
...
saveas(fig2, 'Graphs\2D\ArrayResponse.fig')
close(fig2)
...
saveas(fig3, 'Graphs\2D\ArrayResponse_Range.fig')
close(fig3)
...
xlabel('Azimuth Angle')
ylabel('Response Magnitude')
saveas(fig4, 'Graphs\2D\ArrayResponse_Azimuth.fig')
close(fig4)
...
saveas(fig5, 'Graphs\2D\ArrayResponses_FullRange.fig')
close(fig5)
...
saveas(fig6, 'Graphs\2D\ArrayResponses_Range_Polar.fig')
close(fig6)
...
saveas(fig7, 'Graphs\2D\ArrayResponses_Azimuth_Polar.fig')
close(fig7)
...
saveas(fig8, 'Graphs\2D\RadiationEnergyGround.fig')
close(fig8)
...
saveas(fig9, 'Graphs\2D\RadiationPatternGround.fig')
close(fig9)
