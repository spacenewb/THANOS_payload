function [ObjectiveVariables] = DisplayData(DesignVariables)
...
GlobalScans_hi = 1; % Min number of HiRes global scans during mission (Maybe Sufficient)
...
% Calculated
[Ant1.Lx, Ant1.Lz, Ant1.pho_h, Ant1.Ptx, Ant1.delta_psi, Ant1.delta_theta] = Ant_design(Ant1.res(2), Ant1.res(1), Ant1.g_swath, Orbital.H, Ant1.theta0);
[Ant2.Lx, Ant2.Lz, Ant2.pho_h, Ant2.Ptx, Ant2.delta_psi, Ant2.delta_theta] = Ant_design(Ant2.res(2), Ant2.res(1), Ant2.g_swath, Orbital.H, Ant2.theta0);
...
Final.Voxel_Vol = min([Ant1.pho_h Ant1.pho_h])*Final.HiRes_Cell;

% Objective Variable
ObjectiveVariables = [Final.Voxel_Vol Final.Aa Final.MissionTime];

%% Display stuff
Fin.H = [Orbital.H];
Fin.theta0 = [Ant1.theta0 Ant2.theta0];
Fin.g_swath = [Ant1.g_swath Ant2.g_swath];
Fin.pho_x = [Ant1.pho_x Ant2.pho_x];
Fin.pho_gr = [Ant1.pho_gr Ant2.pho_gr];
Fin.Lx = [Ant1.Lx Ant2.Lx];
Fin.Lz = [Ant1.Lz Ant2.Lz];
Fin.pho_h = [Ant1.pho_h Ant2.pho_h];
Fin.Ptx = [Ant1.Ptx Ant2.Ptx];
Fin.delta_psi = [Ant1.delta_psi Ant2.delta_psi];
Fin.delta_theta = [Ant1.delta_theta Ant2.delta_theta];
Fin.NO = [Scan.Revisit_N (Scan.Revisits*Scan.Revisit_N)];
Fin.T_orbit = [Orbital.T Orbital.T];
Fin.DC = [Scan.DC_orb Scan.DC_orb];
Fin.MD = [Final.MissionTime (Final.MissionTime*(Scan.Global_T_hi/Scan.Global_T_lo))];
