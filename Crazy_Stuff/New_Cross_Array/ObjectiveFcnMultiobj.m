...
% Calculated
[Ant1.Lx, Ant1.Lz, Ant1.pho_h, Ant1.Ptx, Ant1.delta_psi, Ant1.delta_theta, Ant1.SNR_rx_dB] = Ant_design(Ant1.res(2), Ant1.res(1), Ant1.g_swath, Orbital.H, Ant1.theta0);
[Ant2.Lx, Ant2.Lz, Ant2.pho_h, Ant2.Ptx, Ant2.delta_psi, Ant2.delta_theta, Ant2.SNR_rx_dB] = Ant_design(Ant2.res(2), Ant2.res(1), Ant2.g_swath, Orbital.H, Ant2.theta0);
...
Final.SNR_Rx = min([Ant1.SNR_rx_dB Ant2.SNR_rx_dB]);

% Objective Variable
ObjectiveVariables = [Final.Voxel_Vol Final.Aa Final.MissionTime -Final.SNR_Rx];
