...
%%
H_min = max([DeltaV_Alt_Incl(DV,DV_frac) 900])
...
ub = [5000e3 deg2rad(35) 50e3 20 20 5];
...
opts = optimoptions(@gamultiobj,'UseParallel', true, 'PopulationSize', pop_size,...
    'MaxGenerations', max_gen, 'MaxStallGenerations', (max_gen/10),...
    'ConstraintTolerance', 1e-6, 'CrossoverFraction', cross_frac,...
