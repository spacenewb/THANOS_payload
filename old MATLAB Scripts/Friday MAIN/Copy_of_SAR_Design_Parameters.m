...
R_E = physconst('EarthRadius'); % Radius of Earth
Mu_E = 3.986e14; % Gravitational Parameter of Earth
K = physconst('boltzmann'); % Boltzmann constant
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GIVEN DATA
f0 = 9.65e9; % Carrier frequency [Hz]
theta0 = deg2rad(30); % Elevation Angle [rad]
pho_x = 3; % Azimuth Resolution [m]
pho_gr = 3; % Ground range Resolution [m]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ASSUMPTIONS
H = 400e3; % orbit height [m]
v_orb = (Mu_E/(R_E+H))^0.5; % orbit velocity [m/s]
g_swath = 40e3; % ground swath [m] (40 km maximum as per requirement)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
