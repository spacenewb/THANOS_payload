function [ObjectiveVariable] = ObjectiveFcn(DesignVariables)
...
Scan.DC_orb = max([(Scan.ToS_orb/Orbital.T),1]); % Duty Cycle of SAR in 1 Orbit
...
% Objective Variable
% This is not final, we need to talk about what could be the best objective
% variable formula that we can use in single variable optimisation

ObjectiveVariable = Final.HiRes_Cell*Final.Aa*Final.MissionTime;
