function[pho_x, pho_gr, pho_h, Ptx, delta_psi, delta_theta] = Ant_design_rev(Lx, Lz, pho_gr, g_swath, H, theta0)
...
pho_x = Lx/2; % physical antenna length [m]
delta_theta = lambda/Lz;
